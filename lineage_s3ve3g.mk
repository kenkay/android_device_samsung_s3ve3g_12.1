...
PRODUCT_COPY_FILES += \
	vendor/lineage/prebuilt/common/bootanimation/720.zip:system/media/bootanimation.zip
...
# VK Device identifier. This must come after all inclusions
PRODUCT_NAME := lineage_s3ve3g
PRODUCT_DEVICE := s3ve3g
PRODUCT_BRAND := Android
PRODUCT_MODEL := GT-I9301I
PRODUCT_MANUFACTURER := samsung
PRODUCT_RELEASE_NAME := GT_I9301I
